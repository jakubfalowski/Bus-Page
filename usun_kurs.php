...
<html>
    ...
    <body>
        ...
        <div class = "news container">
            <h2 class="center"> Usuwanie kursu </h2>
            ...
            <?php
                ...
                echo "</table><label> Wybierz id kursu który chcesz usunąć</label><form method='post'><select name='kurs'>";
                while($row = $result2->fetch_assoc()){
                    echo "<option value=".$row['id_kursu'].">".$row['id_kursu']."</option>";
                }
                echo "</select><input type='submit' name='submit'></form>";
                if(isset($_POST['submit'])){
                    $sql = "CALL usun_kurs('".$_POST['kurs']."')";
                    $result = $conn->query($sql);
                }        
